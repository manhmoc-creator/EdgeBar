...
public class ToggleReceiver extends BroadcastReceiver {
    @Override public void onReceive(Context c, Intent i) {
        try { String srv = "com.manhmoc.edgebar.v18/com.manhmoc.edgebar.EdgeBarService"; String en = Settings.Secure.getString(c.getContentResolver(), Settings.Secure.ENABLED_ACCESSIBILITY_SERVICES); if (en == null) en = ""; boolean isEn = en.contains(srv);
