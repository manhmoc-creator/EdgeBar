...
/**
 * V19.12.3.6.8 THE ETERNAL EGO — Tile4
...
private void updateTileUI() {
    ...
    String boundId = prefs.getString("tile_slot_4_id", "");
    if (boundId.isEmpty()) {
        t.setLabel("Tile 4 (trống)");
        t.setState(Tile.STATE_INACTIVE);
        t.updateTile();
        return;
    }
    String action = prefs.getString("tilev2_" + boundId + "_act", "NONE");
    String label = prefs.getString("tilev2_" + boundId + "_label", "Tile 4");
    t.setLabel(label);
