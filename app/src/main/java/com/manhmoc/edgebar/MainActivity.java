...
public class MainActivity extends Activity {
    ...
    private final String[] BARS = {"l", "r", "t_l", "t_r", "t_c"}; private final String[] BAR_NAMES = {"ĐÁY TRÁI (V9)", "ĐÁY PHẢI (V9)", "ĐỈNH TRÁI", "ĐỈNH PHẢI", "ĐỈNH GIỮA"};
    ...
    @Override protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView title = new TextView(this); title.setText("⚙️ EdgeBar V13 - Hybrid Engine"); title.setTextColor(Color.WHITE); title.setTextSize(24); title.setPadding(0,0,0,20); main.addView(title);
    ...
    private void switchTab(int index) { tabBoth.setVisibility(index==0?View.VISIBLE:View.GONE); tabLock.setVisibility(index==1?View.VISIBLE:View.GONE); tabHome.setVisibility(index==2?View.VISIBLE:View.GONE); btnBoth.setTextColor(index==0?Color.GREEN:Color.WHITE); btnLock.setTextColor(index==1?Color.GREEN:Color.WHITE); btnHome.setTextColor(index==2?Color.GREEN:Color.WHITE); }
