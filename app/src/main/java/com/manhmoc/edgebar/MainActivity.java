...
public class MainActivity extends Activity {
    ...
    private void renderSliders() { 
        ...
        if(designTabState == 2) { 
            ...
            // 2. GIAO DIỆN HIỆU ỨNG HƠI THỞ (CHUYỂN KHẨU TỪ MAIN VÀO ĐÂY)
            LinearLayout recSys = new LinearLayout(this); recSys.setOrientation(LinearLayout.VERTICAL); recSys.setPadding(0, 40, 0, 0);
            recSys.addView(createSectionTitle("🎤 KHÔNG GIAN HƠI THỞ (BREATH RECORDER)"));
            ...
            designSliderContainer.addView(recSys);
