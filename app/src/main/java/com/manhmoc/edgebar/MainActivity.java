...
import android.app.Activity; import android.app.AlertDialog; import android.app.Dialog; import android.content.ComponentName; import android.content.Context; import android.content.Intent; import android.content.SharedPreferences; import android.content.pm.PackageManager; import android.content.pm.ResolveInfo; import android.graphics.Color; import android.graphics.drawable.GradientDrawable; import android.os.Bundle; import android.provider.Settings; import android.net.Uri; import android.text.TextUtils; import android.view.Gravity; import android.view.View; import android.view.ViewGroup; import android.widget.*; import org.json.JSONObject; import java.util.ArrayList; import java.util.Arrays; import java.util.Iterator; import java.util.List;
...
public class MainActivity extends Activity {
    ...
    private final String CURRENT_VERSION = "V19.12.3.5.2"; 
    ...
    private void reloadActionLabels() {
        ...
        M_BAR_NAMES = new String[]{T("Bottom Right", "Đáy phải"), T("Bottom Left", "Đáy trái"), T("Top Right", "Cạnh Phải"), T("Top Left", "Cạnh Trái"), T("Top Center", "Đỉnh giữa"), T("Bottom Center", "Đáy Giữa"), T("Top Half", "Trung Tâm Trên"), T("Bottom Half", "Trung Tâm Dưới")};
    ...
    private void openMorseMapDialog() {
        ...
        bSave.setOnClickListener(v -> {
            ...
            Toast.makeText(this, "Đã lưu ma trận bàn phím Morse!", Toast.LENGTH_SHORT).show(); d.dismiss();
        });
        d.setContentView(root); d.show();
    }
    ...
    private void buildTilesSpace() {
        pageTiles.addView(createSectionTitle("15 CUSTOM QS TILES"));
        for(int i=1; i<=15; i++) { 
            ...
            CheckBox cbShow = new CheckBox(this); cbShow.setText("Bật Tile này lên Hệ thống"); cbShow.setTextColor(Color.parseColor("#4CAF50")); cbShow.setPadding(0,20,0,0);
            ...
            cbShow.setOnCheckedChangeListener((vBtn, isChecked) -> { getPackageManager().setComponentEnabledSetting(comp, isChecked ? PackageManager.COMPONENT_ENABLED_STATE_ENABLED : PackageManager.COMPONENT_ENABLED_STATE_DISABLED, PackageManager.DONT_KILL_APP); });
            content.addView(cbShow); pageTiles.addView(createDrawer("🔲 QS Tile " + i, content));
        }
    }

    private void buildDesignSpace() {
        pageDesign.addView(createSectionTitle("BACKUP / RESTORE"));
    ...
    private void showPremiumDialog() { String t = "ADB COMMANDS:\nadb shell pm grant com.manhmoc.edgebar android.permission.WRITE_SECURE_SETTINGS\nadb shell appops set com.manhmoc.edgebar SYSTEM_ALERT_WINDOW allow"; ScrollView sv = new ScrollView(this); sv.setPadding(50,50,50,50); TextView tv = new TextView(this); tv.setText(t); tv.setTextColor(Color.WHITE); tv.setTextSize(15f); tv.setLineSpacing(0, 1.3f); sv.addView(tv); new AlertDialog.Builder(this, android.R.style.Theme_DeviceDefault_Dialog_Alert).setTitle("👑 PREMIUM ARCHITECT INFO").setView(sv).setPositiveButton("OK", null).show(); }
