...
public class EdgeBarService extends AccessibilityService {
    ...
    @Override protected void onServiceConnected() {
        ...
        Notification n = new Notification.Builder(this, cid).setContentTitle("EdgeBar 10.7.1 Đang Chạy").setSmallIcon(android.R.drawable.ic_lock_lock).setOngoing(true).build(); startForeground(1, n);
        createFloatingBars();
    }
    ...
    private void createFloatingBars() {
        ...
        GradientDrawable pill = new GradientDrawable(); pill.setColor(Color.parseColor("#B3FFFFFF")); pill.setCornerRadius(100f); // Bo tròn viên thuốc
        ...
        lLockCorner = new View(this); lLockCorner.setBackground(pill);
        rLockCorner = new View(this); rLockCorner.setBackground(pill);
    ...
    private void updateBarLayout(int i) {
        ...
        GradientDrawable gd = new GradientDrawable(); gd.setColor(Color.argb(alpha, 96, 125, 139)); gd.setCornerRadius(24f); // Bo tròn nhẹ nhàng các thanh Sidebar
