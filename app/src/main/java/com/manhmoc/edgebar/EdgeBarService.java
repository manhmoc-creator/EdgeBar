...
public class EdgeBarService extends AccessibilityService {
    ...
    private class CornerView extends View { 
        ...
        public void updateProps(int thick, int alpha) { pStroke.setStrokeWidth(thick); pStroke.setAlpha(alpha); pFill.setAlpha(alpha <= 1 ? alpha : 50); invalidate(); }
        @Override protected void onDraw(Canvas canvas) { super.onDraw(canvas); 
            ...
            if(type==0) { path.moveTo(pad, h); path.lineTo(pad, rad); path.quadTo(pad, pad, rad, pad); path.lineTo(w, pad); hitBox.moveTo(0, h); hitBox.lineTo(0, 0); hitBox.lineTo(w, 0); hitBox.lineTo(0, h); } 
            else if(type==1) { path.moveTo(0, pad); path.lineTo(w-rad, pad); path.quadTo(w-pad, pad, w-pad, rad); path.lineTo(w-pad, h); hitBox.moveTo(0, 0); hitBox.lineTo(w, 0); hitBox.lineTo(w, h); hitBox.lineTo(0, 0); } 
            else if(type==2) { path.moveTo(pad, 0); path.lineTo(pad, h-rad); path.quadTo(pad, h-pad, rad, h-pad); path.lineTo(w, h-pad); hitBox.moveTo(0, 0); hitBox.lineTo(0, h); hitBox.lineTo(w, h); hitBox.lineTo(0, 0); } 
            else if(type==3) { path.moveTo(0, h-pad); path.lineTo(w-rad, h-pad); path.quadTo(w-pad, h-pad, w-pad, h-rad); path.lineTo(w-pad, 0); hitBox.moveTo(w, 0); hitBox.lineTo(w, h); hitBox.lineTo(0, h); hitBox.lineTo(w, 0); } 
