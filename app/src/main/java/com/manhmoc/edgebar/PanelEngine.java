...
ACT_ICON_RES.put("YTDL_DOWNLOAD", android.R.drawable.ic_menu_upload);
    ...
    private static final String[] CUSTOM_ICON_NAMES = {
        ...
        "hand_bones_24px", "handyman_24px", "heart_broken_24px",
        "help_24px", "key_vertical_24px", "keyboard_24px",
        "keyboard_command_key_24px", "light_mode_24px", "lightbulb_24px",
        "link_2_24px", "local_police_24px", "mail_24px",
        "menstrual_health_24px", "mobile_info_24px", "mobile_lock_portrait_24px",
        "mobile_question_24px", "mode_heat_24px", "mode_off_on_24px",
        "movie_24px", "music_note_24px", "music_note_2_24px",
        "nest_protect_24px", "notifications_active_24px", "pet_supplies_24px",
        "phone_in_talk_24px", "photo_camera_24px", "planet_24px",
        "play_arrow_24px", "qr_code_scanner_24px", "recycling_24px",
        "rocket_launch_24px", "routine_24px", "schedule_24px",
        "search_24px", "security_24px", "settings_24px",
        "settings_accessibility_24px", "settings_bluetooth_24px", "settings_heart_24px",
        "settings_power_24px", "settings_voice_24px", "share_location_24px",
        "sim_card_24px", "snowflake_24px", "sports_martial_arts_24px",
        "sports_motorsports_24px", "sports_soccer_24px", "star_24px",
        "stat_0_24px", "stream_24px", "support_24px",
        "token_24px", "touch_app_24px", "translate_24px",
        "two_wheeler_24px", "visibility_24px", "volume_up_24px",
        "warning_24px", "work_24px"
    };
