...
public class HomescreenService extends Service {
    ...
    @Override public void onCreate() {
        ...
        String cid = "eb_v15_home"; NotificationChannel c = new NotificationChannel(cid, "EdgeBar V15 Màn Chính", NotificationManager.IMPORTANCE_LOW); getSystemService(NotificationManager.class).createNotificationChannel(c); Notification n = new Notification.Builder(this, cid).setContentTitle("V15 ADB Màn Chính (Bất tử)").setSmallIcon(android.R.drawable.ic_lock_lock).build(); startForeground(2, n);
