...
ACT_ICON_RES.put("YTDL_DOWNLOAD", android.R.drawable.ic_menu_upload);
    ...
    static final int[] CUSTOM_ICON_POOL = {
        R.drawable.accessible_menu_24px, R.drawable.all_inclusive_24px, R.drawable.alternate_email_24px,
        R.drawable.anchor_24px, R.drawable.android_24px, R.drawable.android_wifi_3_bar_lock_24px,
        R.drawable.api_24px, R.drawable.battery_charging_full_24px, R.drawable.bomb_24px,
        R.drawable.bubble_chart_24px, R.drawable.chess_knight_24px, R.drawable.circles_ext_24px,
        R.drawable.construction_24px, R.drawable.content_cut_24px, R.drawable.crop_24px,
        R.drawable.cycle_24px, R.drawable.dark_mode_24px, R.drawable.data_usage_24px,
        R.drawable.deceased_24px, R.drawable.deployed_code_24px, R.drawable.directions_boat_24px,
        R.drawable.directions_run_24px, R.drawable.distance_24px, R.drawable.diversity_2_24px,
        R.drawable.ecg_heart_24px, R.drawable.eda_24px, R.drawable.edit_24px,
        R.drawable.elderly_24px, R.drawable.emoji_food_beverage_24px, R.drawable.explore_24px,
        R.drawable.eyeglasses_2_24px, R.drawable.fertile_24px, R.drawable.file_present_24px,
        R.drawable.fingerprint_24px, R.drawable.flag_24px, R.drawable.flare_24px,
        R.drawable.flash_on_24px, R.drawable.flashlight_on_24px, R.drawable.flight_24px,
        R.drawable.hand_bones_24px, R.drawable.handyman_24px, R.drawable.heart_broken_24px,
        R.drawable.help_24px, R.drawable.key_vertical_24px, R.drawable.keyboard_24px,
        R.drawable.keyboard_command_key_24px, R.drawable.light_mode_24px, R.drawable.lightbulb_24px,
        R.drawable.link_2_24px, R.drawable.local_police_24px, R.drawable.mail_24px,
        R.drawable.menstrual_health_24px, R.drawable.mobile_info_24px, R.drawable.mobile_lock_portrait_24px,
        R.drawable.mobile_question_24px, R.drawable.mode_heat_24px, R.drawable.mode_off_on_24px,
        R.drawable.movie_24px, R.drawable.music_note_24px, R.drawable.music_note_2_24px,
        R.drawable.nest_protect_24px, R.drawable.notifications_active_24px, R.drawable.pet_supplies_24px,
        R.drawable.phone_in_talk_24px, R.drawable.photo_camera_24px, R.drawable.planet_24px,
        R.drawable.play_arrow_24px, R.drawable.qr_code_scanner_24px, R.drawable.recycling_24px,
        R.drawable.rocket_launch_24px, R.drawable.routine_24px, R.drawable.schedule_24px,
        R.drawable.search_24px, R.drawable.security_24px, R.drawable.settings_24px,
        R.drawable.settings_accessibility_24px, R.drawable.settings_bluetooth_24px, R.drawable.settings_heart_24px,
        R.drawable.settings_power_24px, R.drawable.settings_voice_24px, R.drawable.share_location_24px,
        R.drawable.sim_card_24px, R.drawable.snowflake_24px, R.drawable.sports_martial_arts_24px,
        R.drawable.sports_motorsports_24px, R.drawable.sports_soccer_24px, R.drawable.star_24px,
        R.drawable.stat_0_24px, R.drawable.stream_24px, R.drawable.support_24px,
        R.drawable.token_24px, R.drawable.touch_app_24px, R.drawable.translate_24px,
        R.drawable.two_wheeler_24px, R.drawable.visibility_24px, R.drawable.volume_up_24px,
        R.drawable.warning_24px, R.drawable.work_24px
    };
